<template>
  <div class="">
    <div class="text-center md:py-32 py-20 max-w-2xl mx-auto">
      ...
      <div class="m-5 p-5 max-w-2xl mx-auto">
        <button
          class="bg-primary rounded-md py-2 px-3 hover:bg-primary-white hover:text-primary-black"
        >
          <a href="mailto:bobbyrahmanda1996@gmail.com">Email</a>
        </button>
        <div class="my-4 text-sm text-primary-gray">
          <a
            class="hover:text-primary-white"
            target="_blank"
            href="https://drive.google.com/file/d/1FswCHI9y79GpNM-HcGQJdn-NqVhQV2_g/view?usp=sharing"
            >Download CV</a
          >
        </div>
        <div class="flex items-center justify-center my-6 pt-3">
          ...
          <a href="https://www.instagram.com/rahman.rvbr" target="_blank">
            <svg
              class="mr-3 w-6 hover:bg-black hover:rounded"
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
              width="24"
