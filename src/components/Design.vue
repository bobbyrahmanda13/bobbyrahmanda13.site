<template>
  <div class="flex flex-col h-screen bg-center bg-cover bg-no-repeat">
    <div class="py-20">
      <div
        class="grid place-items-center w-4/5 mx-auto p-10 my-5 sm:my-auto bg-white-600 border-4 border-primary bg-opacity-70 rounded-xl shadow-2xl space-y-5 text-center cursor-pointer"
      >
        <svg
        ...
        <h1 class="text-4xl font-bold uppercase text-primary transition duration-500">
          Coming Soon
        </h1>
        <h2 class="text-lg text-primary-gray transition duration-500">
          I haven't added this page yet because it requires Rest API to retrieve data from Database,
          so it requires Backend to be able to create Rest API and access it on Front End
        </h2>
      </div>
    </div>
  </div>
